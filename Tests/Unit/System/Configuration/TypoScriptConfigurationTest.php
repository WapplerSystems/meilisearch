...
class TypoScriptConfigurationTest extends SetUpUnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['index.']['queue.']['tt_news.']['fields.']['content'] = 'MEILISEARCH_CONTENT';
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['index.']['queue.']['tt_news.']['fields.']['content.']['field'] = 'bodytext';
    ...
    {
        $testPath = 'plugin.tx_t3meilisearch.index.queue.tt_news.fields.content';
    ...
    {
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.'] = [
            'search.' => [
                'faceting.' => [
    ...
    public function canGetIndexQueueConfigurationNames()
    {
        ...
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['index.']['queue.']['custom'] = 1;
        $configuration = new TypoScriptConfiguration($fakeConfigurationArray);
        $enabledIndexQueueNames = $configuration->getEnabledIndexQueueConfigurationNames();
    ...
    public function canGetGroupingAllowGetParameterSwitch()
    {
        ...
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['grouping.']['allowGetParameterSwitch'] = 1;
        $configuration = new TypoScriptConfiguration($fakeConfigurationArray);

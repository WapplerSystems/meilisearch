...
use WapplerSystems\Meilisearch\Search\RelevanceComponent;
    ...
    public function canSetBoostQueries(): void
    {
        $searchConfiguration = [
            'query.' => [
                'boostQuery.' => [
                    'type:pages^100',
                    'type:tx_t3meilisearch_file^400',
                 ],
            ],
        ];
        ...
        self::assertSame('type:tx_t3meilisearch_file^400', $this->getQueryParameters($query)['bq'][1], 'Configured boostQuery was not applied');
    }

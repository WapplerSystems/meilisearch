...
class QueryBuilderTest extends SetUpUnitTestCase
{
    ...
    public function canSetHighlightingFieldList(): void
    {
        ...
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['results.']['resultsHighlighting'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['results.']['resultsHighlighting.']['highlightFields'] = 'title';
    ...
    public function canPassCustomWrapForHighlighting(): void
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['results.']['resultsHighlighting'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['results.']['resultsHighlighting.']['wrap'] = '[A]|[B]';
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
        $query = $this->getInitializedTestSearchQuery('test', $fakeConfiguration);
    ...
    public function canGetQueryFieldsAsStringWhenPassedFromConfiguration(): void
    {
        ...
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['queryFields'] = $input;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
        $query = $this->getInitializedTestSearchQuery('test', $fakeConfiguration);
        $queryParameters = $this->getAllQueryParameters($query);
    ...
    public function canReturnFieldListWhenConfigurationWithReturnFieldsWasPassed(): void
    {
        ...
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['returnFields'] = $input;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
        $query = $this->getInitializedTestSearchQuery('test', $fakeConfiguration);
        $queryParameters = $this->getAllQueryParameters($query);
    ...
    public function canUseFacetMinCountFromConfiguration()
    {
        $input = 10;
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['faceting'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['faceting.']['minimumCount'] = $input;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
    ...
    public function canUseFacetSortByFromConfiguration()
    {
        ...
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['faceting'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['faceting.']['sortBy'] = $input;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
    ...
    public function canTestNumberOfSuggestionsToTryFromConfiguration()
    {
        $input = 9;
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['spellchecking'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['spellchecking.']['numberOfSuggestionsToTry'] = $input;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
    ...
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['phrase'] = 1;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
    ...
    public function canAddPhraseFieldsFromConfiguration()
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['phrase'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['phrase.']['fields'] = 'content^22.0, title^11.0';
    ...
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['bigramPhrase'] = 1;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
        $query = $this->getInitializedTestSearchQuery('foo bar', $fakeConfiguration);
    ...
    public function canAddBigramFieldsFromConfiguration()
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['bigramPhrase'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['bigramPhrase.']['fields'] = 'content^12.0, title^14.0';
    ...
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['trigramPhrase'] = 1;
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
        $query = $this->getInitializedTestSearchQuery('foo bar', $fakeConfiguration);
    ...
    public function canAddTrigramFieldsFromConfiguration()
    {
        $fakeConfigurationArray = [];
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['trigramPhrase'] = 1;
        $fakeConfigurationArray['plugin.']['tx_t3meilisearch.']['search.']['query.']['trigramPhrase.']['fields'] = 'content^12.0, title^14.0';
        $fakeConfiguration = new TypoScriptConfiguration($fakeConfigurationArray);
        $query = $this->getInitializedTestSearchQuery('foo bar', $fakeConfiguration);
        $parameters = $this->getAllQueryParameters($query);

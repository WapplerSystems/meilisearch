...
use WapplerSystems\Meilisearch\Domain\Search\ResultSet\Facets\RangeBased\NumericRange\NumericRangeFacetParser;
...
class NumericRangeFacetParserTest extends SetUpFacetParser
{
    ...
    protected function getNumericRangeFacet(
        ...
        $searchResultSet = $this->initializeSearchResultSetFromFakeResponse(
            'fake_meilisearch_response_with_numericRange_facet.json',
            $facetConfiguration,
            $filters
        );

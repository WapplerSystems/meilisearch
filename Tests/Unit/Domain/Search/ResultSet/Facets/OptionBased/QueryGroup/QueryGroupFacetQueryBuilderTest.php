...
use WapplerSystems\Meilisearch\Domain\Search\ResultSet\Facets\OptionBased\QueryGroup\QueryGroupFacetQueryBuilder;
...
class QueryGroupFacetQueryBuilderTest extends SetUpUnitTestCase
{
    ...
    public function canBuildQueryGroupFacetWithKeepAllFacetsOnSelection()
    {
        ...
        $fakeConfiguration['plugin.']['tx_t3meilisearch.']['search.']['faceting.'] = $fakeFacetConfiguration;

...
class SearchRequestTest extends SetUpUnitTestCase
{
    ...
    {
        $this->searchRequest = new SearchRequest(['tx_t3meilisearch' => ['page' => 2]]);
        self::assertSame(2, $this->searchRequest->getPage(), 'Retrieved unexpected page');

        $this->searchRequest->mergeArguments(['tx_t3meilisearch' => ['page' => 8]]);
    ...
    {
        $query = 'tx_t3meilisearch%5Bq%5D=typo3&tx_t3meilisearch%5Bfilter%5D%5B0%5D=type%253Apages';
    ...
    public function canSetQueryString()
    {
        ...
        self::assertEquals(['tx_t3meilisearch' => ['q' => 'foobar']], $data, 'The argument container did not contain the expected argument');
    }
    ...
    public function canAddOneFacet()
    {
        ...
        $expectedArguments = [];
        $expectedArguments['tx_t3meilisearch']['filter'][0] = 'foo:bar';
    ...
    public function canAddManyFacets()
    {
        ...
        $expectedArguments = [];
        $expectedArguments['tx_t3meilisearch']['filter'][0] = 'type:pages';
        $expectedArguments['tx_t3meilisearch']['filter'][1] = 'type:tt_content';
    ...
    public function canAddFacetsAndQuery()
    {
        ...
        $expectedArguments = [];
        $expectedArguments['tx_t3meilisearch']['q'] = 'mysearch';
        $expectedArguments['tx_t3meilisearch']['filter'][0] = 'type:tt_content';
    ...
    {
        $query = 'tx_t3meilisearch%5Bq%5D=typo3&tx_t3meilisearch%5Bfilter%5D%5B0%5D=type%253Apages&tx_t3meilisearch%5Bfilter%5D%5B1%5D=type%253Anews';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    {
        $query = 'tx_t3meilisearch%5Bq%5D=typo3&tx_t3meilisearch%5Bfilter%5D%5B0%5D=type%253Apages&tx_t3meilisearch%5Bfilter%5D%5B1%5D=type%253Aevents';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    {
        $query = 'tx_t3meilisearch%5Bq%5D=typo3&tx_t3meilisearch%5Bfilter%5D%5B0%5D=type%253Apages&tx_t3meilisearch%5Bfilter%5D%5B1%5D=type%253Aevents&tx_t3meilisearch%5Bfilter%5D%5B2%5D=created%253A1-4';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    {
        $query = 'tx_t3meilisearch%5Bq%5D=typo3&tx_t3meilisearch%5Bsort%5D=title asc';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    public function canRemoveSorting()
    {
        ...
        self::assertTrue(isset($requestAsArray['tx_t3meilisearch']['sort']), 'Sorting was not set but was expected to be set');

        $request->removeSorting();
        self::assertFalse($request->getHasSorting(), 'Expected that sorting was removed, but is still present');

        $requestAsArray = $request->getAsArray();
        self::assertFalse(isset($requestAsArray['tx_t3meilisearch']['sort']), 'Sorting was set but was not expected to be set');
    }
    ...
    {
        $query = 'tx_t3meilisearch%5Bq%5D=typo3';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    public function canResetAllGroupItemPages()
    {
        ...
        self::assertCount(2, $requestArguments['tx_t3meilisearch']['groupPage'], 'Expected to have two group pages registered');

        $request->removeAllGroupItemPages();
        $requestArguments = $request->getAsArray();
        self::assertArrayNotHasKey('groupPage', $requestArguments['tx_t3meilisearch'], 'Expected to have two group pages registered');
    }

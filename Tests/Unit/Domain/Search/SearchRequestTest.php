...
class SearchRequestTest extends SetUpUnitTestCase
{
    ...
    {
        $this->searchRequest = new SearchRequest(['tx_meilisearch' => ['page' => 2]]);
        self::assertSame(2, $this->searchRequest->getPage(), 'Retrieved unexpected page');

        $this->searchRequest->mergeArguments(['tx_meilisearch' => ['page' => 8]]);
    ...
    {
        $query = 'tx_meilisearch%5Bq%5D=typo3&tx_meilisearch%5Bfilter%5D%5B0%5D=type%253Apages';
    ...
    public function canSetQueryString()
    {
        ...
        self::assertEquals(['tx_meilisearch' => ['q' => 'foobar']], $data, 'The argument container did not contain the expected argument');
    }
    ...
    public function canAddOneFacet()
    {
        ...
        $expectedArguments = [];
        $expectedArguments['tx_meilisearch']['filter'][0] = 'foo:bar';
    ...
    public function canAddManyFacets()
    {
        ...
        $expectedArguments = [];
        $expectedArguments['tx_meilisearch']['filter'][0] = 'type:pages';
        $expectedArguments['tx_meilisearch']['filter'][1] = 'type:tt_content';
    ...
    public function canAddFacetsAndQuery()
    {
        ...
        $expectedArguments = [];
        $expectedArguments['tx_meilisearch']['q'] = 'mysearch';
        $expectedArguments['tx_meilisearch']['filter'][0] = 'type:tt_content';
    ...
    {
        $query = 'tx_meilisearch%5Bq%5D=typo3&tx_meilisearch%5Bfilter%5D%5B0%5D=type%253Apages&tx_meilisearch%5Bfilter%5D%5B1%5D=type%253Anews';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    {
        $query = 'tx_meilisearch%5Bq%5D=typo3&tx_meilisearch%5Bfilter%5D%5B0%5D=type%253Apages&tx_meilisearch%5Bfilter%5D%5B1%5D=type%253Aevents';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    {
        $query = 'tx_meilisearch%5Bq%5D=typo3&tx_meilisearch%5Bfilter%5D%5B0%5D=type%253Apages&tx_meilisearch%5Bfilter%5D%5B1%5D=type%253Aevents&tx_meilisearch%5Bfilter%5D%5B2%5D=created%253A1-4';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    {
        $query = 'tx_meilisearch%5Bq%5D=typo3&tx_meilisearch%5Bsort%5D=title asc';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    public function canRemoveSorting()
    {
        ...
        self::assertTrue(isset($requestAsArray['tx_meilisearch']['sort']), 'Sorting was not set but was expected to be set');

        $request->removeSorting();
        self::assertFalse($request->getHasSorting(), 'Expected that sorting was removed, but is still present');

        $requestAsArray = $request->getAsArray();
        self::assertFalse(isset($requestAsArray['tx_meilisearch']['sort']), 'Sorting was set but was not expected to be set');
    }
    ...
    {
        $query = 'tx_meilisearch%5Bq%5D=typo3';
        $request = $this->getSearchRequestFromQueryString($query);
    ...
    public function canResetAllGroupItemPages()
    {
        ...
        self::assertCount(2, $requestArguments['tx_meilisearch']['groupPage'], 'Expected to have two group pages registered');

        $request->removeAllGroupItemPages();
        $requestArguments = $request->getAsArray();
        self::assertArrayNotHasKey('groupPage', $requestArguments['tx_meilisearch'], 'Expected to have two group pages registered');
    }

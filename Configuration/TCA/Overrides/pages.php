...
ExtensionManagementUtility::addTCAcolumns(
    ...
    [
        'no_search_sub_entries' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3_meilisearch/Resources/Private/Language/locallang_tca.xlf:pages.no_search_sub_entries',
            'config' => [
                'type' => 'check',
...
$GLOBALS['TCA']['pages']['palettes']['slimmed_miscellaneous'] = [
    ...
    'showitem' => 'no_search_sub_entries;LLL:EXT:t3_meilisearch/Resources/Private/Language/locallang_tca.xlf:pages.no_search_sub_entries',
];

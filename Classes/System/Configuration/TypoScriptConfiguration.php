...
class TypoScriptConfiguration
{
     ...
     *
     * In the context of a frontend content element the path plugin.tx_t3meilisearch is
     * merged recursive with overrule with the content element specific typoscript
     * settings, like plugin.tx_t3meilisearch_PiResults_Results, and possible flex form settings
     * (depends on the meilisearch plugin).
     *
     * Example: plugin.tx_t3meilisearch.search.targetPage
     * returns $GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_t3meilisearch.']['search.']['targetPage']
     *
     ...
     * (depends on the meilisearch plugin).
     *
     * Example: plugin.tx_t3meilisearch.index.queue.tt_news.fields.content
     * returns $GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_t3meilisearch.']['index.']['queue.']['tt_news.']['fields.']['content.']
    ...
    {
        $path = 'plugin.tx_t3meilisearch.enabled';
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.index.additionalFields.', $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_t3meilisearch.index.fieldProcessingInstructions.
     */
    public function getIndexFieldProcessingInstructionsConfiguration(array $defaultIfEmpty = []): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.index.fieldProcessingInstructions.', $defaultIfEmpty);
    }

    /**
     * Retrieves the indexing configuration array for an indexing queue by configuration name.
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.
     */
    public function getIndexQueueConfigurationByName(string $configurationName, array $defaultIfEmpty = []): array
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.pages.additionalPageIds
     */
    ...
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.additionalPageIds';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.pages.allowedPageTypes
     */
    ...
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.allowedPageTypes';
        $result = $this->getValueByPathOrDefaultValue($path, '');
        if (trim($result) === '') {
            return $defaultIfEmpty;
        }
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.*.allowedPageTypes
     */
    public function getAllIndexQueueAllowedPageTypesArray(): array
    {
        $configuration = $this->configurationAccess->get('plugin.tx_t3meilisearch.index.queue.');
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.pages.excludeContentByClass
     */
    public function getIndexQueuePagesExcludeContentByClassArray(array $defaultIfEmpty = []): array
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.pages.excludeContentByClass';
        $result = $this->getValueByPathOrDefaultValue($path, '');
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.type or configurationName
     */
    public function getIndexQueueTypeOrFallbackToConfigurationName(string $configurationName = ''): string
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.type';
        ...
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.table';
        $type = $this->getValueByPath($path);
        if (!is_null($type)) {
            trigger_error(
                'queue.[indexConfig].table is deprecated and will be removed in v13. Use plugin.tx_t3meilisearch.index.queue.[indexConfig].type instead.',
                E_USER_DEPRECATED
            );
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.fields.
     */
    public function getIndexQueueFieldsConfigurationByConfigurationName(string $configurationName = '', array $defaultIfEmpty = []): array
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.fields.';
        return $this->getObjectByPathOrDefault($path, $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.indexer
     */
    ...
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.indexer';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName> = 1
     */
    ...
    {
        $tablesToIndex = [];
        $path = 'plugin.tx_t3meilisearch.index.queue.';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.recursiveUpdateFields
     */
    public function getIndexQueueConfigurationRecursiveUpdateFields(string $configurationName, array $defaultIfEmpty = []): array
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.recursiveUpdateFields';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.initialPagesAdditionalWhereClause
     */
    public function getInitialPagesAdditionalWhereClause(string $configurationName): string
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.initialPagesAdditionalWhereClause';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.additionalWhereClause
     */
    public function getIndexQueueAdditionalWhereClauseByConfigurationName(string $configurationName): string
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.additionalWhereClause';
     ...
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.initialization
     */
    ...
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.initialization';
        return (string)$this->getValueByPathOrDefaultValue($path, $defaultIfEmpty);
    }
    ...
    *
    * plugin.tx_t3meilisearch.index.queue.<configurationName>.indexingPriority
    */
    public function getIndexQueueIndexingPriorityByConfigurationName(string $configurationName, int $defaultIfEmpty = 0): int
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.indexingPriority';
     ...
     * This method is used to retrieve the className of a queue initializer for a certain indexing configuration
     *
     * plugin.tx_t3meilisearch.index.queue.<configurationName>.indexQueue
     *
    ...
    {
        $path = 'plugin.tx_t3meilisearch.index.queue.' . $configurationName . '.indexQueue';
     ...
     *
     * plugin.tx_t3meilisearch._LOCAL_LANG.
     */
    public function getLocalLangConfiguration(array $defaultIfEmpty = []): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch._LOCAL_LANG.', $defaultIfEmpty);
    }
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.debugOutput', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.query.filters
     */
    public function getLoggingQueryFilters(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.query.filters', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.query.queryString
     */
    public function getLoggingQueryQueryString(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.query.queryString', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.query.searchWords
     */
    public function getLoggingQuerySearchWords(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.query.searchWords', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.query.rawGet
     */
    public function getLoggingQueryRawGet(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.query.rawGet', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.query.rawPost
     */
    public function getLoggingQueryRawPost(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.query.rawPost', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.query.rawDelete
     */
    public function getLoggingQueryRawDelete(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.query.rawDelete', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.exceptions
     */
    public function getLoggingExceptions(bool $defaultIfEmpty = true): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.exceptions', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.indexing
     */
    public function getLoggingIndexing(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.indexing', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.indexing.queue
     */
    public function getLoggingIndexingQueue(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.indexing.queue', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.indexing.queue.<indexQueueConfiguration>
     */
    public function getLoggingIndexingQueueOperationsByConfigurationNameWithFallBack(string $indexQueueConfiguration, bool $defaultIfEmpty = false): bool
    {
        ...
        $path = 'plugin.tx_t3meilisearch.logging.indexing.queue.' . $indexQueueConfiguration;
        $result = $this->getValueByPathOrDefaultValue($path, $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.indexing.pageIndexed
     */
    public function getLoggingIndexingPageIndexed(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.indexing.pageIndexed', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.indexing.missingTypo3SearchMarkers
     */
    public function getLoggingIndexingMissingTypo3SearchMarkers(bool $defaultIfEmpty = true): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.indexing.missingTypo3SearchMarkers', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.logging.indexing.indexQueueInitialization
     */
    public function getLoggingIndexingIndexQueueInitialization(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.logging.indexing.indexQueueInitialization', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.enableDebugMode
     */
    public function getEnabledDebugMode(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.enableDebugMode', $defaultIfEmpty);
        return $this->getBool($result);
    }
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.', $defaultIfEmpty);
    }

    /**
     * Indicates if elevation should be used or not
     *
     * plugin.tx_t3meilisearch.search.elevation
     */
    public function getSearchElevation(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.elevation', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.elevation.markElevatedResults
     */
    public function getSearchElevationMarkElevatedResults(bool $defaultIfEmpty = true): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.elevation.markElevatedResults', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.elevation.forceElevation
     */
    public function getSearchElevationForceElevation(bool $defaultIfEmpty = true): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.elevation.forceElevation', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.variants
     */
    public function getSearchVariants(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.variants', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.variants.variantField
     */
    public function getSearchVariantsField(string $defaultIfEmpty = 'variantId'): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.variants.variantField', $defaultIfEmpty);
    }

    /**
     * Indicates if expanding of collapsed items it activated.
     *
     * plugin.tx_t3meilisearch.search.variants.expand
     */
    public function getSearchVariantsExpand(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.variants.expand', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.variants.limit
     */
    public function getSearchVariantsLimit(int $defaultIfEmpty = 10): int
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.variants.limit', $defaultIfEmpty);
        return (int)$result;
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.frequentSearches
     */
    public function getSearchFrequentSearches(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.frequentSearches', $defaultIfEmpty);
        return $this->getBool($result);
    }
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.frequentSearches.', $defaultIfEmpty);
    }

    /**
     * Retrieves the minimum font size that should be used for the frequentSearches.
     *
     * plugin.tx_t3meilisearch.search.frequentSearches.minSize
     */
    public function getSearchFrequentSearchesMinSize(int $defaultIfEmpty = 14): int
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.frequentSearches.minSize', $defaultIfEmpty);
        return (int)$result;
    }
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.frequentSearches.maxSize', $defaultIfEmpty);
        return (int)$result;
    }
     ...
     * Indicates if frequent searches should be show or not.
     *
     * plugin.tx_t3meilisearch.search.frequentSearches.useLowercaseKeywords
     */
    public function getSearchFrequentSearchesUseLowercaseKeywords(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.frequentSearches.useLowercaseKeywords', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.initializeWithEmptyQuery
     */
    public function getSearchInitializeWithEmptyQuery(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.initializeWithEmptyQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.initializeWithQuery
     */
    public function getSearchInitializeWithQuery(string $defaultIfEmpty = ''): string
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.initializeWithQuery', $defaultIfEmpty);
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.lastSearches', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.lastSearches.mode
     */
    public function getSearchLastSearchesMode(string $defaultIfEmpty = 'user'): string
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.lastSearches.mode', $defaultIfEmpty);
        return (string)$result;
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.lastSearches.limit
     */
    public function getSearchLastSearchesLimit(int $defaultIfEmpty = 10): int
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.lastSearches.limit', $defaultIfEmpty);
        return (int)$result;
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.showResultsOfInitialEmptyQuery
     */
    public function getSearchShowResultsOfInitialEmptyQuery(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.showResultsOfInitialEmptyQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.showResultsOfInitialQuery
     */
    public function getSearchShowResultsOfInitialQuery(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.showResultsOfInitialQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.sorting
     */
    public function getSearchSorting(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.sorting', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.sorting.options.
     */
    public function getSearchSortingOptionsConfiguration(array $defaultIfEmpty = []): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.sorting.options.', $defaultIfEmpty);
    }

    /**
     * Retrieves the sorting default order for a sort option.
     *
     * plugin.tx_t3meilisearch.search.sorting.options.<sortOptionName>.defaultOrder
     *
     * or
     *
     * plugin.tx_t3meilisearch.search.sorting.defaultOrder
     */
    public function getSearchSortingDefaultOrderBySortOptionName(string $sortOptionName = '', string $defaultIfEmpty = 'asc'): string
    {
        $sortOrderSpecificPath = 'plugin.tx_t3meilisearch.search.sorting.options.' . $sortOptionName . '.defaultOrder';
        ...
        $commonPath = 'plugin.tx_t3meilisearch.search.sorting.defaultOrder';
    ...
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.trustedFields', '');
     ...
     *
     * plugin.tx_t3meilisearch.search.keepExistingParametersForNewSearches
     */
    public function getSearchKeepExistingParametersForNewSearches(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.keepExistingParametersForNewSearches', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.query.allowEmptyQuery
     */
    public function getSearchQueryAllowEmptyQuery(string $defaultIfEmpty = ''): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.allowEmptyQuery', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.query.filter.
     */
    public function getSearchQueryFilterConfiguration(array $defaultIfEmpty = []): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.query.filter.', $defaultIfEmpty);
    }
    ...
    {
        $this->configurationAccess->set('plugin.tx_t3meilisearch.search.query.filter.', $configuration);
    }
    ...
    {
        $this->configurationAccess->reset('plugin.tx_t3meilisearch.search.query.filter.__pageSections');
    }

    /**
     * Returns the configured queryFields from TypoScript
     *
     * plugin.tx_t3meilisearch.search.query.queryFields
     */
    public function getSearchQueryQueryFields(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.queryFields', $defaultIfEmpty);
    }

    /**
     * This method is used to check if a phrase search is enabled or not
     *
     * plugin.tx_t3meilisearch.search.query.phrase = 1
     */
    public function getPhraseSearchIsEnabled(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.phrase', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.query.phrase.fields
     */
    public function getSearchQueryPhraseFields(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.phrase.fields', $defaultIfEmpty);
    }

    /**
     * This method is used to check if a bigram phrase search is enabled or not
     *
     * plugin.tx_t3meilisearch.search.query.bigramPhrase = 1
     */
    public function getBigramPhraseSearchIsEnabled(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.bigramPhrase', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     * Returns the configured phrase fields from TypoScript
     *
     * plugin.tx_t3meilisearch.search.query.bigramPhrase.fields
     */
    public function getSearchQueryBigramPhraseFields(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.bigramPhrase.fields', $defaultIfEmpty);
    }

    /**
     * This method is used to check if a trigram phrase search is enabled or not
     *
     * plugin.tx_t3meilisearch.search.query.trigramPhrase = 1
     */
    public function getTrigramPhraseSearchIsEnabled(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.trigramPhrase', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.query.trigramPhrase.fields
     */
    public function getSearchQueryTrigramPhraseFields(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.query.trigramPhrase.fields', $defaultIfEmpty);
    }

    /**
     * Returns the configured returnFields as array.
     *
     * plugin.tx_t3meilisearch.search.query.returnFields
     */
    public function getSearchQueryReturnFieldsAsArray(array $defaultIfEmpty = []): array
    {
        $returnFields = $this->getValueByPath('plugin.tx_t3meilisearch.search.query.returnFields');
     ...
     *
     * plugin.tx_t3meilisearch.search.targetPage
     */
    public function getSearchTargetPage(): int
    {
        $targetPage = (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.targetPage', 0);
        if ($targetPage === 0) {
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.targetPage.', $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.results.siteHighlighting
     */
    public function getSearchResultsSiteHighlighting(bool $defaultIfEmpty = true): bool
    {
        $isSiteHighlightingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.siteHighlighting', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.search.results.resultsHighlighting
     */
    public function getIsSearchResultsHighlightingEnabled(bool $defaultIfEmpty = false): bool
    {
        $isHighlightingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsHighlighting', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.search.results.resultsHighlighting.highlightFields
     */
    public function getSearchResultsHighlightingFields(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsHighlighting.highlightFields', $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.results.resultsHighlighting.fragmentSize
     */
    public function getSearchResultsHighlightingFragmentSize(int $defaultIfEmpty = 200): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsHighlighting.fragmentSize', $defaultIfEmpty);
    }

    /**
     * Returns the fragmentSeparator for highlighted segments.
     *
     * plugin.tx_t3meilisearch.search.results.resultsHighlighting.fragmentSeparator
     */
    public function getSearchResultsHighlightingFragmentSeparator(string $defaultIfEmpty = '[...]'): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsHighlighting.fragmentSeparator', $defaultIfEmpty);
    }

    /**
     * Returns the number of results that should be shown per page.
     *
     * plugin.tx_t3meilisearch.search.results.resultsPerPage
     */
    public function getSearchResultsPerPage(int $defaultIfEmpty = 10): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsPerPage', $defaultIfEmpty);
    }

    /**
     * Returns the available options for the per page switch.
     *
     * plugin.tx_t3meilisearch.search.results.resultsPerPageSwitchOptions
     */
    public function getSearchResultsPerPageSwitchOptionsAsArray(array $defaultIfEmpty = []): array
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsPerPageSwitchOptions', '');
     ...
     *
     * plugin.tx_t3meilisearch.search.results.maxPaginatorLinks
     */
    public function getMaxPaginatorLinks(int $defaultIfEmpty = 0): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.maxPaginatorLinks', $defaultIfEmpty);
    }

    /**
     * Returns the configured wrap for the resultHighlighting.
     *
     * plugin.tx_t3meilisearch.search.results.resultsHighlighting.wrap
     */
    public function getSearchResultsHighlightingWrap(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.results.resultsHighlighting.wrap', $defaultIfEmpty);
    }
    ...
    {
        $isFacetingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.spellchecking', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.search.spellchecking.numberOfSuggestionsToTry
     */
    public function getSearchSpellcheckingNumberOfSuggestionsToTry(int $defaultIfEmpty = 1): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.spellchecking.numberOfSuggestionsToTry', $defaultIfEmpty);
    }

    /**
     * Indicates if a second search should be fired from the spellchecking suggestion if no results could be found.
     *
     * plugin.tx_t3meilisearch.search.spellchecking.searchUsingSpellCheckerSuggestion
     */
    public function getSearchSpellcheckingSearchUsingSpellCheckerSuggestion(bool $defaultIfEmpty = false): bool
    {
        $result = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.spellchecking.searchUsingSpellCheckerSuggestion', $defaultIfEmpty);
        return $this->getBool($result);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.faceting
     */
    public function getSearchFaceting(bool $defaultIfEmpty = false): bool
    {
        $isFacetingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting', $defaultIfEmpty);
        return $this->getBool($isFacetingEnabled);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.faceting.facets.<facetName>.showEvenWhenEmpty
     *
     * or
     *
     * plugin.tx_t3meilisearch.search.faceting.showEmptyFacets
     */
    public function getSearchFacetingShowEmptyFacetsByName(string $facetName = '', bool $defaultIfEmpty = false): bool
    {
        $facetSpecificPath = 'plugin.tx_t3meilisearch.search.faceting.facets.' . $facetName . '.showEvenWhenEmpty';
        ...
        // no specific setting, check common setting
        $commonPath = 'plugin.tx_t3meilisearch.search.faceting.showEmptyFacets';
     ...
     *
     * plugin.tx_t3meilisearch.search.faceting.showAllLink.wrap
     */
    public function getSearchFacetingShowAllLinkWrap(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.showAllLink.wrap', $defaultIfEmpty);
    }

    /**
     * Returns the link url parameters that should be added to a facet.
     *
     * plugin.tx_t3meilisearch.search.faceting.facetLinkUrlParameters
     */
    public function getSearchFacetingFacetLinkUrlParameters(string $defaultIfEmpty = ''): string
    {
        return trim($this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.facetLinkUrlParameters', $defaultIfEmpty));
    }

    /**
     * Returns if the facetLinkUrlsParameters should be included in the reset link.
     *
     * plugin.tx_t3meilisearch.search.faceting.facetLinkUrlParameters.useForFacetResetLinkUrl
     */
    public function getSearchFacetingFacetLinkUrlParametersUseForFacetResetLinkUrl(bool $defaultIfEmpty = true): bool
    {
        $useForFacetResetLinkUrl = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.facetLinkUrlParameters.useForFacetResetLinkUrl', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.search.faceting.minimumCount
     */
    public function getSearchFacetingMinimumCount(int $defaultIfEmpty = 1): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.minimumCount', $defaultIfEmpty);
    }

    /**
     * Return the configured limit value for facets, used for displaying.
     *
     * plugin.tx_t3meilisearch.search.faceting.limit
     */
    public function getSearchFacetingLimit(int $defaultIfEmpty = 10): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.limit', $defaultIfEmpty);
    }

    /**
     * Return the configured limit value for facets, used for the response.
     *
     * plugin.tx_t3meilisearch.search.faceting.facetLimit
     */
    public function getSearchFacetingFacetLimit(int $defaultIfEmpty = 100): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.facetLimit', $defaultIfEmpty);
    }

    /**
     * Return the configured url parameter style value for facets, used for building faceting parameters.
     *
     * plugin.tx_t3meilisearch.search.faceting.urlParameterStyle
     */
     ...
     *
     * plugin.tx_t3meilisearch.search.faceting.urlParameterSort
     */
     ...
     *
     * plugin.tx_t3meilisearch.search.faceting.sortBy
     */
    public function getSearchFacetingSortBy(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.sortBy', $defaultIfEmpty);
    }

    /**
     * Returns if a facets should be kept on selection. Global faceting setting
     * can also be configured on facet level by using
     * (plugin.tx_t3meilisearch.search.faceting.facets.<fieldName>.keepAllOptionsOnSelection)
     *
     * plugin.tx_t3meilisearch.search.faceting.keepAllFacetsOnSelection
     */
    public function getSearchFacetingKeepAllFacetsOnSelection(bool $defaultIfEmpty = false): bool
    {
        $keepAllOptionsOnSelection = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.keepAllFacetsOnSelection', $defaultIfEmpty);
     ...
     * plugin.tx_t3meilisearch.search.faceting.keepAllFacetsOnSelection has been enabled
     *
     * plugin.tx_t3meilisearch.search.faceting.countAllFacetsForSelection
     */
    public function getSearchFacetingCountAllFacetsForSelection(bool $defaultIfEmpty = false): bool
    {
        $countAllFacetsForSelection = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.faceting.countAllFacetsForSelection', $defaultIfEmpty);
    ...
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.faceting.facets.', $defaultIfEmpty);
    }

    /**
     * Returns the configuration of a single facet by facet name.
     *
     * plugin.tx_t3meilisearch.search.faceting.facets.<facetName>
     */
    public function getSearchFacetingFacetByName(string $facetName, array $defaultIfEmpty = []): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.faceting.facets.' . $facetName . '.', $defaultIfEmpty);
    }

    /**
     * Indicates if statistics is enabled or not.
     *
     * plugin.tx_t3meilisearch.statistics
     */
    public function getStatistics(bool $defaultIfEmpty = false): bool
    {
        $isStatisticsEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.statistics', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.statistics.anonymizeIP
     */
    public function getStatisticsAnonymizeIP(int $defaultIfEmpty = 0): int
    {
        $anonymizeToLength = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.statistics.anonymizeIP', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.statistics.addDebugData
     */
    public function getStatisticsAddDebugData(bool $defaultIfEmpty = false): bool
    {
        $statisticsAddDebugDataEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.statistics.addDebugData', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.suggest
     */
    public function getSuggest(bool $defaultIfEmpty = false): bool
    {
        $isSuggestionEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.suggest', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.suggest.forceHttps
     */
    public function getSuggestForceHttps(bool $defaultIfEmpty = false): bool
    {
        $isHttpsForced = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.suggest.forceHttps', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.suggest.numberOfSuggestions
     */
    public function getSuggestNumberOfSuggestions(int $defaultIfEmpty = 10): int
    {
        $numberOfSuggestions = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.suggest.numberOfSuggestions', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.suggest.showTopResults
     */
    public function getSuggestShowTopResults(bool $defaultIfEmpty = true): bool
    {
        $showTopResults = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.suggest.showTopResults', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.suggest.numberOfTopResults
     */
    public function getSuggestNumberOfTopResults(int $defaultIfEmpty = 5): int
    {
        $numberOfTopResults = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.suggest.numberOfTopResults', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.suggest.additionalTopResultsFields
     */
    public function getSuggestAdditionalTopResultsFields(array $defaultIfEmpty = []): array
    {
        $additionalTopResultsFields = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.suggest.additionalTopResultsFields', '');
     ...
     *
     * plugin.tx_t3meilisearch.view.templateFiles.<fileKey>
     */
    public function getViewTemplateByFileKey(string $fileKey, string $defaultIfEmpty = ''): string
    {
        $templateFileName = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.view.templateFiles.' . $fileKey, $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.view.templateFiles.[fileKey].availableTemplates.
     */
    public function getAvailableTemplatesByFileKey(string $fileKey): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.view.templateFiles.' . $fileKey . '.availableTemplates.');
    }
     ...
     *
     * plugin.tx_t3meilisearch.view.pluginNamespace
     */
    public function getSearchPluginNamespace(string $defaultIfEmpty = SearchRequest::DEFAULT_PLUGIN_NAMESPACE): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.view.pluginNamespace', $defaultIfEmpty);
    }
     ...
     *
     * plugin.tx_t3meilisearch.search.ignoreGlobalQParameter
     */
    public function getSearchIgnoreGlobalQParameter(bool $defaultIfEmpty = false): bool
    {
        $enableQParameter = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.ignoreGlobalQParameter', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.search.additionalPersistentArgumentNames
     */
    public function getSearchAdditionalPersistentArgumentNames(array $defaultIfEmpty = []): array
    {
        $additionalPersistentArgumentNames = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.additionalPersistentArgumentNames', '');
     ...
     *
     * plugin.tx_t3meilisearch.search.grouping
     */
    public function getIsSearchGroupingEnabled(bool $defaultIfEmpty = false): bool
    {
        $groupingEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.grouping', $defaultIfEmpty);
    ...
    {
        $groupingGetParameterSwitchEnabled = $this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.grouping.allowGetParameterSwitch', $defaultIfEmpty);
     ...
     *
     * plugin.tx_t3meilisearch.search.grouping.numberOfGroups
     */
    public function getSearchGroupingNumberOfGroups(int $defaultIfEmpty = 5): int
    {
        return (int)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.grouping.numberOfGroups', $defaultIfEmpty);
    }

    /**
     * Returns the sortBy configuration for the grouping.
     *
     * plugin.tx_t3meilisearch.search.grouping.sortBy
     */
    public function getSearchGroupingSortBy(string $defaultIfEmpty = ''): string
    {
        return (string)$this->getValueByPathOrDefaultValue('plugin.tx_t3meilisearch.search.grouping.sortBy', $defaultIfEmpty);
    }
    ...
    {
        $groupingConfiguration = $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.grouping.');
     ...
     * Returns:
     *
     * plugin.tx_t3meilisearch.search.grouping.groups.<groupName>.numberOfResultsPerGroup if it is set otherwise
     * plugin.tx_t3meilisearch.search.grouping.numberOfResultsPerGroup
     */
    public function getSearchGroupingResultLimit(string $groupName, ?int $defaultIfEmpty = 1): ?int
    {
        $specificPath = 'plugin.tx_t3meilisearch.search.grouping.groups.' . $groupName . '.numberOfResultsPerGroup';
        ...
        $commonPath = 'plugin.tx_t3meilisearch.search.grouping.numberOfResultsPerGroup';
    ...
    /**
     * Returns everything that is configured for the groups (plugin.tx_t3meilisearch.search.grouping.groups.)
     *
     * plugin.tx_t3meilisearch.search.grouping.groups.
     */
    public function getSearchGroupingGroupsConfiguration(?array $defaultIfEmpty = []): array
    {
        return $this->getObjectByPathOrDefault('plugin.tx_t3meilisearch.search.grouping.groups.', $defaultIfEmpty);
    }

...
class FrontendUserSession
{
    ...
    {
        $this->feUser->setKey('ses', 'tx_t3meilisearch_resultsPerPage', $requestedPerPage);
    }

    public function getPerPage(): int
    {
        return (int)$this->feUser->getKey('ses', 'tx_t3meilisearch_resultsPerPage');
    }

    public function getHasPerPage(): bool
    {
        return $this->feUser->getKey('ses', 'tx_t3meilisearch_resultsPerPage') !== null;
    }

    public function getLastSearches(): array
    {
        $result = $this->feUser->getKey('ses', 'tx_t3meilisearch_lastSearches');
        return is_array($result) ? $result : [];
    }

    public function setLastSearches(array $lastSearches): void
    {
        $this->feUser->setKey('ses', 'tx_t3meilisearch_lastSearches', $lastSearches);
    }
}

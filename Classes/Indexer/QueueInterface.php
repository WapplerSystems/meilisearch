...
interface QueueInterface
{
     ...
     */
    public function updateItem(string $itemType, int|string $itemUid, int $forcedChangeTime = 0, ?array $validLanguageUids = null): int;
     ...
     */
    public function containsItem(string $itemType, int|string $itemUid): bool;
     ...
     * @return bool TRUE if the item is found in the queue, FALSE otherwise
     */
    public function containsItemWithRootPageId(string $itemType, int|string $itemUid, int $rootPageId, string $indexingConfiguration): bool;
     ...
     */
    public function containsIndexedItem(string $itemType, int|string $itemUid): bool;
     ...
     *                   different value for non-database-record types.
     */
    public function deleteItem(string $itemType, int|string $itemUid): void;
     ...
     *
     * @param int|string $itemId Index Queue item uid
     * @return ?ItemInterface The request Index Queue item or NULL if no item with $itemId was found
     */
    public function getItem(int|string $itemId): ?ItemInterface;

...
namespace WapplerSystems\Meilisearch\Indexer\Initializer;
...
class Page extends AbstractInitializer
{
    ...
    protected function initializeMountPointPages(): bool
    {
        ...
        $databaseConnection = $this->queueItemRepository->getConnectionForAllInTransactionInvolvedTables(
            'tx_t3meilisearch_indexqueue_item',
            'tx_t3meilisearch_indexqueue_indexing_property'
        );
    ...
    protected function addMountedPagesToIndexQueue(array $mountedPages, array $mountProperties): void
    {
        ...
        $initializationQuery = 'INSERT INTO tx_t3meilisearch_indexqueue_item (root, item_type, item_uid, indexing_configuration, indexing_priority, changed, has_indexing_properties, pages_mountidentifier, errors) '

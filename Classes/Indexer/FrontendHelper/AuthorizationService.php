...
class AuthorizationService extends AbstractAuthenticationService
{
     ...
     */
    public const MEILISEARCH_INDEXER_USERNAME = '__MeilisearchIndexerUser__';
    ...
    public function getUser(): ?array
    {
        ...
        return [
            'uid' => 0,
            'username' => self::MEILISEARCH_INDEXER_USERNAME,
            'authenticated' => true,
        ];
    }
    ...
    public function authUser(array $user): int
    {
        ...
        if ($user['username'] == self::MEILISEARCH_INDEXER_USERNAME) {

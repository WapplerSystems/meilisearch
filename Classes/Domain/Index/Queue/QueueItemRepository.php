 ...
 * Handles all CRUD operations to tx_t3meilisearch_indexqueue_item table
 */
class QueueItemRepository extends AbstractRepository
{
    protected string $table = 'tx_t3meilisearch_indexqueue_item';
    ...
    private function buildQueryForPropertyDeletion(
        ...
        $queryBuilderForSelectingProperties
            ->select('items.uid')
            ->from('tx_t3meilisearch_indexqueue_indexing_property', 'properties')
            ->innerJoin(
                'properties',
                $this->table,
                'items',
        ...
        $queryBuilderForDeletingProperties->delete('tx_t3meilisearch_indexqueue_indexing_property')->where(

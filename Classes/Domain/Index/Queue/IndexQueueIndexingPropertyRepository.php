 ...
 * Handles all CRUD operations to tx_t3meilisearch_indexqueue_indexing_property table
 */
class IndexQueueIndexingPropertyRepository extends AbstractRepository
{
    protected string $table = 'tx_t3meilisearch_indexqueue_indexing_property';

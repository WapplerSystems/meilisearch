...
{
    protected string $table = 'tx_t3meilisearch_statistics';

    /**
     * Fetches most popular search keys words from the table tx_t3meilisearch_statistics
     *
     ...
     * plugin.tx_t3meilisearch.search.frequentSearches.select configuration.
     *
     * @throws DBALException
     */
